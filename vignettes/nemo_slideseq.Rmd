...
## Download the data to your R session
...
## Load the package and set instructions
...
```{r, echo=FALSE}
knitr::include_graphics("images/nemo_slideseq/09-spatPlot2D.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("images/nemo_slideseq/10-spatPlot2D.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("images/nemo_slideseq/11-screePlot.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("images/nemo_slideseq/12-PCA.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("images/nemo_slideseq/13-UMAP.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("images/nemo_slideseq/14-spatPlot2D.png")
```
