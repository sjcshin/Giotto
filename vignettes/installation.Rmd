...
You can install dev branch versions by using `devtools::install_github()` instead, alongside one of the following dev branch paths as shown below. Do not update other Giotto modules that should be installed from dev branch if prompted.
