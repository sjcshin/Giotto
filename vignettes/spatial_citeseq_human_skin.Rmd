...
x = data.table::fread(paste0(data_dir, "GSE213264_RAW/GSM6578065_humanskin_RNA.tsv.gz"))
...
```{r, eval=FALSE}
rna_matrix = data.table::fread(paste0(data_dir, "GSE213264_RAW/GSM6578065_humanskin_RNA.tsv.gz"))
...
protein_matrix = data.table::fread(paste0(data_dir, "GSE213264_RAW/GSM6578074_humanskin_protein.tsv.gz"))
...
my_giotto_image <- createGiottoImage(gobject = my_giotto_object,
                                     do_manual_adj = TRUE,
                                     scale_factor = 0.5,
                                     mg_object = paste0(data_dir, "skin.jpg"),
                                     negative_y = TRUE)
...
## 6.6 Plot spatial locations by cluster
...
## 8.1 Spatially correlated genes
