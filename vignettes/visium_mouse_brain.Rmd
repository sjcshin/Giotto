...
sc_expression <- file.path(results_folder, "brain_sc_expression_matrix.txt.gz")
sc_metadata <- file.path(results_folder, "brain_sc_metadata.csv")
...
hmrf_folder <- file.path(results_folder, "11_HMRF")
