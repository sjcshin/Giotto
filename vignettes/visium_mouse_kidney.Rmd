...
```{r, eval=FALSE}
spatPlot2D(
    gobject = visium_kidney, show_image = T, point_alpha = 0.7,
...
spatDimPlot(
    gobject = visium_kidney, cell_color = "leiden_clus",
...
```{r, eval=FALSE}
spatDimPlot(
    gobject = visium_kidney, cell_color = "nr_feats", color_as_factor = F,
    dim_point_size = 2, spat_point_size = 2.5
)
```
...
```{r, eval=FALSE}
gini_markers_subclusters <- findMarkers_one_vs_all(
    gobject = visium_kidney,
    method = "gini",
...
violinPlot(visium_kidney,
    feats = unique(topgenes_gini), cluster_column = "leiden_clus",
...
spatPlot(visium_kidney,
    cell_color = "leiden_clus", show_grid = T,
...
spatPlot(
    gobject = visium_kidney, show_network = T,
...
heatmSpatialCorFeats(visium_kidney,
    ...
    save_param = list(
        save_name = "22-z1-heatmap_correlated_genes",
        save_format = "pdf",
        base_height = 6,
...
netw_ranks <- rankSpatialCorGroups(visium_kidney,
    ...
    use_clus_name = "spat_netw_clus",
    save_param = list(
        save_name = "22-z2-rank_correlated_groups",
        base_height = 3,
        base_width = 5
    )
)
...
visium_kidney <- createSpatialNetwork(
    gobject = visium_kidney,
    minimum_k = 2,
    name = "Delaunay_full"
)
