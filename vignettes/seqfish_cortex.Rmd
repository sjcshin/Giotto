...
getSpatialDataset(dataset = "seqfish_SS_cortex", 
                  directory = data_path, 
                  method = "wget")
```
...
SS_seqfish <- doLeidenSubCluster(gobject = SS_seqfish,
                                 ...
                                 resolution = 0.2, 
                                 k_neighbors = 10,
                                 pca_param = list(expression_values = "normalized", scale_unit = FALSE),
...
clusters_cell_types <- c(
    "L6 eNeuron", "L4 eNeuron", "L2/3 eNeuron", "L5 eNeuron",
    "Lhx6 iNeuron", "Adarb2 iNeuron",
    "endothelial", "mural",
    "OPC", "Olig",
    "astrocytes", "microglia"
)
names(clusters_cell_types) <- c(
    1.1, 2.1, 3.1, 4.1,
    5.1, 5.2,
    6.1, 6.2,
    7.1, 7.2,
...
cell_type_order <- c(
    "L6 eNeuron", "L5 eNeuron", "L4 eNeuron", "L2/3 eNeuron",
